...
function jumpBox(){
showFlyBox.innerHTML = "<a-entity id='flyBox' obj-model='obj:#box-obj; mtl:#box-mtl' position='2 -3 -4' rotation='0 20 0' scale='0.05 0.05 0.05' onclick='shwoRobot()' sound='src: #message; autoplay: true; volume:2;' ></a-entity>"
...
getYourText.innerHTML += "<a-plane id='messagePlane' color='#292931'  width='3' height='1' rotation='0 0 0' position='1.1 0.2 -0.5' opacity='0.5'></a-plane>"

moveBox.innerHTML +="<a-animation attribute='rotation' from='0 20 0' to='10 -30 0' during='1200' delay='3000' ></a-animation>"

};

var getMessage = "Welcome to Georgia Tech.\n You have a message. \n Click the fly-box to read the message."
var startMessage = "A time-travel machine has arrived on campus. Walk around campus to find the time machine, then you can travel back and see historical buildings around campus! Click the robot to show dstance of time machine."
...
displayRobot.innerHTML = "<a-entity id='robotobj' obj-model='obj:#robot-obj; mtl:#robot-mtl' scale='0.05 0.05 0.05' position='0 -2 -5' rotation='0 -25 0' onclick='showPortal()' sound='src: #showUp; autoplay: true; volume:2;'></a-entity>"
